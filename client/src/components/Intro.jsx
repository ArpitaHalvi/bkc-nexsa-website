    ...
    >
      <AnimatePresence>
        <motion.div
          ...
          className="z-10 w-full mt-35 p-10 flex justify-center align-middle flex-col"
        >
          ...
          <p className="text-center text-xs md:text-base md:text-md md:w-3/4 lg:w-1/2 mx-auto pt-1 pb-2 md:py-3 tracking-tight leading-tight">
            ...
            eius optio esse quibusdam corrupti perferendis! Quaerat vero
            ratione, quam aliquam necessitatibus soluta quibusdam distinctio.
            Neque!
          </p>
          <NavLink
            to="/about"
        ...
        <motion.div
          ...
          transition={{ type: "tween", duration: 1.5, ease: "easeOut" }}
          className="w-3/4 rounded-2xl overflow-hidden shadow-lg shadow-gray-400 bg-transparent"
        >
          <video loop muted autoPlay playsInline className="object-cover ">
