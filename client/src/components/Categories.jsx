export default function Categories() {
  ...
  return (
    <section className="w-full flex flex-col justify-center items-center h-screen  bg-black">
      <h2 className="w-full sm:w-1/2 text-center md:w-full text-bold text-2xl px-4 font-bold tracking-tighter uppercase">
